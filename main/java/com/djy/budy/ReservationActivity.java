    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ybutton.setOnClickListener(new DoubleClickListener() {
            ...
            public void onSingleClick() {
                tts.speak(com.djy.budy.LoginActivity.identify + "이 맞으십니까? 맞다면 이 부분을 더블클릭해주세요", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        nbutton.setOnClickListener(new DoubleClickListener() {
            ...
            @Override
            public void onSingleClick() {
                tts.speak(com.djy.budy.LoginActivity.identify+"이 아니십니까? 예약하고자 하는 버스가 아니라면 이 부분을 더블클릭해주세요", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
    }
}