...
if __name__ == "__main__":
    ...
    # print(BT.getBusInformation('32020', '34')) #GGB234000021 #GGB234000026 (노선번호)
    print(BT.getBusThrghSttnList('32020', 'WJB251000082'))  # 오리역 GGB206000215 GGB206000040 (정류장 번호)
