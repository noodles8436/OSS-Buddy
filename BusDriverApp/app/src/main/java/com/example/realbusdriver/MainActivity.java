    ...
    public void btn_Click(View view) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, (dialogInterface, i) -> {
                    ...
                    if(!JoinActivity.saveBD.isDriverExist()){
                    ...
                    if(!JoinActivity.saveBD.getDriverVehicleNo().equals(vehicleNo) ||
                            !JoinActivity.saveBD.getDriverRouteNo().equals(routeNo)){
                    ...
                    NetworkBus.setDriverName(JoinActivity.saveBD.getDriverName());
                    NetworkBus.setDriverUID(JoinActivity.saveBD.getDriverUID());
