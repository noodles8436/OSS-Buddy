    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resbutton.setOnClickListener(new DoubleClickListener() {
            ...
            public void onDoubleClick() {
                ...
                tts.speak(String.valueOf(resbutton.getText())+"번", TextToSpeech.QUEUE_FLUSH,null);
        ...
        resbutton.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if (identify.equals(null)) {
                        ...
                        tts.speak(identify + "버스로 예약하시겠습니까? 맞으시면 화면 왼쪽을 더블클릭하세요.", TextToSpeech.QUEUE_FLUSH, null);
